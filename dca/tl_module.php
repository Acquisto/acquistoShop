 ...
 */
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoProductDetails'] = '{title_legend},name,type;{contaoShop_image},contaoShop_imageSrc,contaoShop_imageSize,contaoShop_imageMargin,contaoShop_imageFloating,contaoShop_imageFullsize;{galerie_options:hide},acquistoShop_galerie_imageSize,acquistoShop_galerie_imageMargin,acquistoShop_galerie_imageFloating,acquistoShop_galerie_imageFullsize;{socialmedia},contaoShop_socialFacebook,contaoShop_socialTwitter;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoProductFilter']  = '{title_legend},name,headline,type;{config_legend};{expert_legend:hide},cssID,space;';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoBasketWidget']   = '{title_legend},name,headline,type;{config_legend},contaoShop_jumpTo;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoProductList']    = '{title_legend},name,type;{config_legend},contaoShop_jumpTo,contaoShop_numberOfItems,perPage,acquistoShop_elementsPerRow,acquistoShop_listTemplate;{list_images:hide},contaoShop_imageSrc,acquistoShop_galerie_imageSize,acquistoShop_galerie_imageMargin,acquistoShop_galerie_imageFloating;{categorie_image},contaoShop_imageSize,contaoShop_imageMargin,contaoShop_imageFloating;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoFilterList']     = '{title_legend},name,headline,type;{config_legend},acquistoShop_tags,acquistoShop_zustand,acquistoShop_hersteller,acquistoShop_produkttype,acquistoShop_warengruppe,acquistoShop_markedProducts;{list_settings},contaoShop_jumpTo,contaoShop_numberOfItems,perPage,acquistoShop_elementsPerRow,acquistoShop_listTemplate;{list_images:hide},contaoShop_imageSrc,acquistoShop_galerie_imageSize,acquistoShop_galerie_imageMargin,acquistoShop_galerie_imageFloating;{expert_legend:hide},cssID,space;';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoRecently']       = '{title_legend},name,headline,type;{config_legend},contaoShop_jumpTo,contaoShop_numberOfItems;{list_images:hide},contaoShop_imageSrc,acquistoShop_galerie_imageSize,acquistoShop_galerie_imageMargin,acquistoShop_galerie_imageFloating;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoTagCloud']       = '{title_legend},name,headline,type;{config_legend},acquistoShop_excludeTags,contaoShop_jumpTo;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoVersand']        = '{title_legend},name,headline,type;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoBasket']         = '{title_legend},name,headline,type;{config_legend},acquistoShop_basketType,acquistoShop_guestOrder,contaoShop_jumpTo,acquistoShop_AGBFile;{email_legend},acquistoShop_emailTyp,acquistoShop_emailTemplate,acquistoShop_emailTemplate_seller;{fields:hide},acquistoShop_selFields;{deliver:hide},acquistoShop_selDeliver;{addon_legend},acquistoShop_fieldsAddon;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoAGB']            = '{title_legend},name,headline,type;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoBreadcrumb']     = '{title_legend},name,headline,type;{config_legend},contaoShop_jumpTo;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoSearch']         = '{title_legend},name,headline,type;{config_legend},acquistoShop_Searchfields,contaoShop_imageSrc,contaoShop_jumpTo;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoCategories']     = '{title_legend},name,headline,type;{config_legend},contaoShop_levelOffset,contaoShop_showLevel,contaoShop_hardLimit,contaoShop_jumpTo;[reference:hide},contaoShop_reference,contaoShop_referencePage;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoOrderList']      = '{title_legend},name,headline,type;{config_legend},contaoShop_jumpTo;{expert_legend:hide},cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoCoupon']         = '{title_legend},name,headline,type;{expert_legend:hide},cssID,space;';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoOrderDetails']   = '{title_legend},name,headline,type;{config_legend};{expert_legend:hide},cssID,space;';
$GLOBALS['TL_DCA']['tl_module']['palettes']['ModuleAcquistoCurrency']       = '{title_legend},name,headline,type;{config_legend};{expert_legend:hide},cssID,space;';
